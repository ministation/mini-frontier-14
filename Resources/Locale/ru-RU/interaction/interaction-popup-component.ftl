...
petting-success-engineer-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } блестящей металлической голове.
petting-success-janitor-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } влажной металлической голове.
petting-success-medical-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } стерильной металлической голове.
petting-success-service-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } ухоженной металлической голове.
petting-success-syndicate-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } зловещей металлической голове.
...
petting-failure-generic-cyborg = Вы тянетесь погладить { $target }, но { $target } занят перечислением законов!
petting-failure-salvage-cyborg = Вы тянетесь погладить { $target }, но { $target } занят сверлением!
petting-failure-engineer-cyborg = Вы тянетесь погладить { $target }, но { $target } занят ремонтом!
petting-failure-janitor-cyborg = Вы тянетесь погладить { $target }, но { $target } занят уборкой!
petting-failure-medical-cyborg = Вы тянетесь погладить { $target }, но { $target } занят спасением жизней!
petting-failure-service-cyborg = Вы тянетесь погладить { $target }, но { $target } занят обслуживанием!
petting-failure-syndicate-cyborg = Вы тянетесь погладить { $target }, но предательская сущность { POSS-ADJ($target) } заставляет вас передумать.

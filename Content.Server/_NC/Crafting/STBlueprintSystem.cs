...
namespace Content.Server._NC.Crafting;
/// <summary>
...
public sealed class STBlueprintSystem : EntitySystem
{
    ...
    private const string WORKBENCH_TAG = "FrontierWorkbench";
    ...
    public override void Initialize()
    {
        ...
        _workbenchNamesById = _proto.EnumeratePrototypes<EntityPrototype>()
            .Where(entity =>
